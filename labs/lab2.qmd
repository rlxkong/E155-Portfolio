...
![Figure 3: Calculations to find the resistor value following the transistor](lab2_images/led_calc.JPG)
:::
...
![Figure 4: Block Diagram of the top module](lab2_images/block_diagram.JPG)
...
![Figure 5: Schematic of the dual seven-segment physical circuit](lab2_images/sevenseg.jpg)
![Figure 6: Schematic of the scanning keyboard physical circuit](lab2_images/keyboard.jpg)
:::
Figure 5 shows the schematic of the dual 7-segment physical circuit. The dual 7-segment display is connected to the labeled GPIO pins through a current-limiting resistor and powered through PNP transistors from the FPGA 3.3V supply.
Figure 6 shows the schematic of the keyboard scanning circuit. The keyboard is connected to the labeled GPIO pins and the row are connected via a resistor through a NPN transistor. The LEDs are also connected to GPIO pins with a 
...
![Figure 7: Top-level module testbench simulation results.](lab2_images/top_end.png)
